...
%                 tof = -1000*cmdBytes(2);
                ...
                defPulse('theta3', amps(4), mods(4), lengths(4), phases(4), spacings(4));
                defPulse('theta4', amps(5), mods(5), lengths(5), phases(5), spacings(5));
                defBlock('pulsed_SL', {'init_pul'}, reps(1), markers(1), trigs(1));
                defBlock('{-Y,Y}', {'theta1', 'theta2'}, reps(2:3), markers(2:3), trigs(2:3));
                defBlock('{Y,-Y}', {'theta3', 'theta4'}, reps(4:5), markers(4:5), trigs(4:5));
                makeBlocks({'pulsed_SL', '{-Y,Y}', '{Y,-Y}'}, ch, repeatSeq);
                ...
                numberOfPulses_total = (reps(2)+ reps(3))*repeatSeq(2) +(reps(4) + reps(5))*repeatSeq(3);
